...
MLTON_CODEGEN_STATIC_INLINE Bool_t Word16_negCheckP(Int16_t);
...
MLTON_CODEGEN_STATIC_INLINE Bool_t Word32_negCheckP(Int32_t);
...
MLTON_CODEGEN_STATIC_INLINE Bool_t Word64_negCheckP(Int64_t);
...
MLTON_CODEGEN_STATIC_INLINE Bool_t Word8_negCheckP(Int8_t);
