...
val matrix_initFromMMFile = _prim "Matrix_initFromMMFile" : NullString8.t -> Pointer.t;
val matrix_initFromFile = _prim "Matrix_initFromFile" : NullString8.t -> Pointer.t;
val matrix_initFromHexFile = _prim "Matrix_initFromHexFile" : NullString8.t -> Pointer.t;
