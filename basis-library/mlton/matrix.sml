...
structure Prim = Primitive.MLton.Matrix
    ...
    val initFromHexFile = fn (s) =>
                            Prim.matrix_initFromHexFile (Primitive.NullString8.fromString (String.nullTerm s))
    val initFromMMFile = fn (s) =>
                            Prim.matrix_initFromMMFile (Primitive.NullString8.fromString (String.nullTerm s))
    val initFromFile = fn (s) =>
                            Prim.matrix_initFromFile (Primitive.NullString8.fromString (String.nullTerm s))
    val create = fn (a1, a2) =>
